...
<script<?= function_exists('pgpCspNonceAttribute') ? pgpCspNonceAttribute() : '' ?> src="/portalgp/ct/administracion/catalogo/estados_comerciales/assets/estados_comerciales.js"></script>
<?php
