...
if ($tablaExiste) {
    try {
        ...
        if ($filtroTexto !== '') {
            $conditions[] = "(ISNULL(desc_comuna, '') LIKE :filtro OR CAST(id_comuna AS NVARCHAR(10)) LIKE :filtro)";
        ...
        $loadError = 'No fue posible cargar las comunas. Detalle técnico: ' . $exception->getMessage();
    }
}
