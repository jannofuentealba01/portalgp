...
if ($tablaExiste) {
    try {
        ...
        if ($filtroTexto !== '') {
            $conditions[] = "(ISNULL(desc_estado, '') LIKE :filtro OR CAST(id_estado_arrendatario AS NVARCHAR(10)) LIKE :filtro)";
        ...
        $loadError = 'No fue posible cargar los estados de arrendatarios. Detalle técnico: ' . $exception->getMessage();
    }
}
