...
try {
    ...
    try {
        ...
        $sheet->setCellValue('B2', 'Persona natural');
        $sheet->setCellValue('C2', 'Juan Pérez');
        $sheet->setCellValue('D2', 'María Soto');
        $sheet->setCellValue('E2', 'juan@correo.cl; contacto@correo.cl');
        $sheet->setCellValue('F2', '+56 9 1234 5678; +56 2 2345 6789');
        $sheet->setCellValue('G2', 'Av. Ejemplo 123');
        $sheet->setCellValue('H2', 'Santiago');
        ...
        $tmpFile = tempnam(sys_get_temp_dir(), 'msp2_arrend_tpl_');
        if ($tmpFile === false) {
        ...
        $filename = 'plantilla_importacion_arrendatarios_msp2.xlsx';
