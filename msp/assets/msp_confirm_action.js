(() => {
    const modalEl = document.getElementById('msp_confirm_action_modal');
    const titleEl = document.getElementById('msp_confirm_action_title');
    const messageEl = document.getElementById('msp_confirm_action_message');
    const cancelBtn = document.getElementById('msp_confirm_action_cancel');
    const acceptBtn = document.getElementById('msp_confirm_action_accept');
    const reasonWrap = document.getElementById('msp_confirm_action_reason_wrap');
    const reasonLabel = document.getElementById('msp_confirm_action_reason_label');
    const reasonInput = document.getElementById('msp_confirm_action_reason_input');
    const reasonError = document.getElementById('msp_confirm_action_reason_error');
