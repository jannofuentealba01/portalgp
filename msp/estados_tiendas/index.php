...
if ($tablaExiste) {
    try {
        ...
        if ($filtroTexto !== '') {
            $search = msp2BuildSearchCondition($filtroTexto, ['desc_estado', 'id_estado_tienda'], 'estado_tienda_buscar', 'id_estado_tienda');
        ...
        $loadError = pgpPublicException($exception, 'msp.estados_tiendas.index', 'No fue posible cargar los estados de tiendas.');
    }
}
        ...
        <?php else: ?>
            <form method="get" class="row g-2 mb-3 align-items-end">
                ...
                <div class="col-12 col-md-2 d-flex gap-2">
                    ...
                    <?php if ($filtroTexto !== ''): ?><a class="btn btn-outline-secondary" href="<?php echo msp2Escape(msp2Url('estados_tiendas/index.php')); ?>" title="Limpiar" aria-label="Limpiar"><i class="bi bi-x-lg"></i></a><?php endif; ?>
                </div>
            </form>
