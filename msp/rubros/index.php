...
if ($tablaExiste) {
    try {
        ...
        if ($filtroTexto !== '') {
            $search = msp2BuildSearchCondition($filtroTexto, ['nombre_rubro', 'id_rubro'], 'rubros_buscar', 'id_rubro');
        ...
        $loadError = pgpPublicException($exception, 'msp.rubros.index', 'No fue posible cargar los rubros.');
    }
}
        ...
        <?php else: ?>
            <form method="get" class="row g-2 mb-3 align-items-end">
                ...
                <div class="col-12 col-md-2 d-flex gap-2">
                    ...
                    <?php if ($filtroTexto !== ''): ?><a class="btn btn-outline-secondary" href="<?php echo msp2Escape(msp2Url('rubros/index.php')); ?>" title="Limpiar" aria-label="Limpiar"><i class="bi bi-x-lg"></i></a><?php endif; ?>
                </div>
            </form>
