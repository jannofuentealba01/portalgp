    ...
    <div class="msp-hub-grid">
        <article class="msp-hub-card">
            ...
            <div class="msp-hub-content">
                ...
                <a class="btn btn-primary btn-sm" href="<?php echo msp2Escape(msp2Url('tiendas/index.php')); ?>">Gestionar tiendas</a>
            </div>
        </article>
        <article class="msp-hub-card">
            <div class="msp-hub-icon"><i class="bi bi-door-open" aria-hidden="true"></i></div>
            <div class="msp-hub-content">
                <h2>Locales</h2>
                <p>Revisa espacios disponibles u ocupados y administra su información física y medidores.</p>
                <a class="btn btn-outline-primary btn-sm" href="<?php echo msp2Escape(msp2Url('locales/index.php')); ?>">Consultar locales</a>
            </div>
        </article>
    </div>
</main>
