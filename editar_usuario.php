...
if (!isset($_SESSION['usuario'])) {
    echo "<script>alert('Debes iniciar sesi�n.'); window.location.href = 'login.php';</script>";
    exit();
}
...
<style>
    ...
    .btn-volver {
        ...
        color: #fff;
        border-radius: 4px; /* Ajusta el radio para que sea m�s rectangular */
        padding: 10px 20px; /* Ajusta el tama�o interno del bot�n */
        border: none; /* Remueve bordes predeterminados si es necesario */
        cursor: pointer; /* Muestra un cursor de mano al pasar sobre el bot�n */
        font-size: 16px; /* Ajusta el tama�o del texto */
    ...
    .btn-editar {
		border-radius: 4px !important; /* Ajusta el radio para que sea m�s rectangular */
        padding: 10px 20px !important; /* Ajusta el tama�o interno del bot�n */
        border: none !important; /* Remueve bordes predeterminados si es necesario */
        cursor: pointer !important; /* Muestra un cursor de mano al pasar sobre el bot�n */
    ...
    .btn-eliminar {
        ...
        color: #fff;
		border-radius: 4px; /* Ajusta el radio para que sea m�s rectangular */
        padding: 10px 10px; /* Ajusta el tama�o interno del bot�n */
        border: none; /* Remueve bordes predeterminados si es necesario */
        cursor: pointer; /* Muestra un cursor de mano al pasar sobre el bot�n */
        font-size: 16px; /* Ajusta el tama�o del texto */
    }
   ...
   .edit-field input {
        ...
        border: 1px solid #ced4da; /* A�ade un borde visible */
        border-radius: 4px; /* Esquinas ligeramente redondeadas */
        text-transform: uppercase; /* Mantiene el texto en may�sculas */
        width: 300px; /* Cambia el ancho aqu� */
	...
	body {
        ...
        min-height: 100vh; /* Altura m�nima igual a la altura de la ventana */
    }
